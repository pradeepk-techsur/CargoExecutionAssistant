...
last_updated: 2026-09-15T00:53:59Z
...
- Build: `npm run build` → pass
- Tests: `npm test` → pass
- Fix attempts: 0/3 — Wave 7: full build green; 430 tests (unit 111 + db 114 + api 75 + arch 130). Architecture suite grown by navigation.spec + headers.spec. a11y sign-offs + USWDS conformance register shipped as artefacts. E2E 29/29 per executor.
...
[1m[7m[36m RUN [39m[27m[22m [36mv2.1.5 [39m[90m/home/daytona/project[39m
 ...
 [32m✓[39m server/test/unit/config.spec.ts [2m([22m[2m28 tests[22m[2m)[22m[90m 2[2mms[22m[39m
 [32m✓[39m server/test/unit/throttle.spec.ts [2m([22m[2m8 tests[22m[2m)[22m[90m 1[2mms[22m[39m
 [32m✓[39m server/test/unit/redaction.spec.ts [2m([22m[2m6 tests[22m[2m)[22m[90m 4[2mms[22m[39m
 [32m✓[39m server/test/unit/cookies.spec.ts [2m([22m[2m14 tests[22m[2m)[22m[90m 1[2mms[22m[39m
 [32m✓[39m server/test/unit/contract.spec.ts [2m([22m[2m5 tests[22m[2m)[22m[90m 0[2mms[22m[39m
 [32m✓[39m server/test/unit/scaffolding.spec.ts [2m([22m[2m4 tests[22m[2m)[22m[90m 0[2mms[22m[39m
...
[2m Test Files [22m [1m[32m9 passed[39m[22m[90m (9)[39m
[2m      Tests [22m [1m[32m111 passed[39m[22m[90m (111)[39m
[2m   Start at [22m 00:45:21
[2m   Duration [22m 603ms[2m (transform 68ms, setup 0ms, collect 406ms, tests 105ms, environment 0ms, prepare 23ms)[22m
...
[1m[7m[36m RUN [39m[27m[22m [36mv2.1.5 [39m[90m/home/daytona/project[39m
 ...
 [32m✓[39m server/test/db/chain.spec.ts [2m([22m[2m6 tests[22m[2m)[22m[33m 850[2mms[22m[39m
 ...
 [32m✓[39m server/test/db/coupling.spec.ts [2m([22m[2m15 tests[22m[2m)[22m[90m 250[2mms[22m[39m
 [32m✓[39m server/test/db/provenance.spec.ts [2m([22m[2m27 tests[22m[2m)[22m[33m 370[2mms[22m[39m
 [32m✓[39m server/test/db/hitl.spec.ts [2m([22m[2m10 tests[22m[2m)[22m[90m 193[2mms[22m[39m
 [32m✓[39m server/test/db/session.service.spec.ts [2m([22m[2m11 tests[22m[2m)[22m[33m 385[2mms[22m[39m
 [32m✓[39m server/test/db/writer.spec.ts [2m([22m[2m9 tests[22m[2m)[22m[90m 72[2mms[22m[39m
 [32m✓[39m server/test/db/harness.spec.ts [2m([22m[2m2 tests[22m[2m)[22m[90m 97[2mms[22m[39m

[2m Test Files [22m [1m[32m8 passed[39m[22m[90m (8)[39m
[2m      Tests [22m [1m[32m114 passed[39m[22m[90m (114)[39m
[2m   Start at [22m 00:45:22
[2m   Duration [22m 2.71s[2m (transform 107ms, setup 0ms, collect 170ms, tests 2.45s, environment 0ms, prepare 22ms)[22m
...
[1m[7m[36m RUN [39m[27m[22m [36mv2.1.5 [39m[90m/home/daytona/project[39m
 ...
 [32m✓[39m server/test/api/guard.spec.ts [2m([22m[2m34 tests[22m[2m)[22m[33m 393[2mms[22m[39m
 [32m✓[39m server/test/api/expiry.spec.ts [2m([22m[2m11 tests[22m[2m)[22m[33m 342[2mms[22m[39m
 [32m✓[39m server/test/api/session.spec.ts [2m([22m[2m11 tests[22m[2m)[22m[33m 396[2mms[22m[39m
 [32m✓[39m server/test/api/actor.spec.ts [2m([22m[2m15 tests[22m[2m)[22m[90m 135[2mms[22m[39m
 [32m✓[39m server/test/api/boot.spec.ts [2m([22m[2m4 tests[22m[2m)[22m[90m 50[2mms[22m[39m

[2m Test Files [22m [1m[32m5 passed[39m[22m[90m (5)[39m
[2m      Tests [22m [1m[32m75 passed[39m[22m[90m (75)[39m
[2m   Start at [22m 00:45:24
[2m   Duration [22m 1.59s[2m (transform 76ms, setup 0ms, collect 183ms, tests 1.32s, environment 0ms, prepare 22ms)[22m
...
[2m   Start at [22m 00:45:26
[2m   Duration [22m 543ms[2m (transform 96ms, setup 0ms, collect 209ms, tests 246ms, environment 0ms, prepare 23ms)[22m
```
...
- Build: `npm run build` → pass
- Tests: `npm test` → pass
- Fix attempts: 0/3 — Phase gate (final regression): full build + entire suite green on final tree — 430 tests (unit 111 + db 114 [Phase 1 substrate] + api 75 + arch 130). Code review made 0 source commits; this is the phase regression statement.
...
[1m[7m[36m RUN [39m[27m[22m [36mv2.1.5 [39m[90m/home/daytona/project[39m
 ...
 [32m✓[39m server/test/unit/canonical.spec.ts [2m([22m[2m19 tests[22m[2m)[22m[90m 58[2mms[22m[39m
...
[2m Test Files [22m [1m[32m9 passed[39m[22m[90m (9)[39m
[2m      Tests [22m [1m[32m111 passed[39m[22m[90m (111)[39m
[2m   Start at [22m 00:49:55
[2m   Duration [22m 610ms[2m (transform 71ms, setup 0ms, collect 410ms, tests 108ms, environment 0ms, prepare 24ms)[22m
...
[1m[7m[36m RUN [39m[27m[22m [36mv2.1.5 [39m[90m/home/daytona/project[39m
 ...
 [32m✓[39m server/test/db/chain.spec.ts [2m([22m[2m6 tests[22m[2m)[22m[33m 841[2mms[22m[39m
   [33m[2m✓[22m[39m TEST-DB-13 & TEST-DB-14 — sequencing under concurrency and chain refusal at commit[2m > [22mTEST-DB-13: two concurrent appends produce contiguous sequences 4 and 5 with correct linkage, the second blocked until the first commits [33m435[2mms[22m[39m
 [32m✓[39m server/test/db/immutability.spec.ts [2m([22m[2m34 tests[22m[2m)[22m[90m 224[2mms[22m[39m
 [32m✓[39m server/test/db/coupling.spec.ts [2m([22m[2m15 tests[22m[2m)[22m[90m 242[2mms[22m[39m
 [32m✓[39m server/test/db/provenance.spec.ts [2m([22m[2m27 tests[22m[2m)[22m[33m 363[2mms[22m[39m
 [32m✓[39m server/test/db/hitl.spec.ts [2m([22m[2m10 tests[22m[2m)[22m[90m 191[2mms[22m[39m
...
[2m      Tests [22m [1m[32m114 passed[39m[22m[90m (114)[39m
[2m   Start at [22m 00:49:55
[2m   Duration [22m 2.64s[2m (transform 97ms, setup 0ms, collect 157ms, tests 2.39s, environment 0ms, prepare 22ms)[22m
...
[1m[7m[36m RUN [39m[27m[22m [36mv2.1.5 [39m[90m/home/daytona/project[39m
 ...
 [32m✓[39m server/test/api/guard.spec.ts [2m([22m[2m34 tests[22m[2m)[22m[33m 397[2mms[22m[39m
 [32m✓[39m server/test/api/expiry.spec.ts [2m([22m[2m11 tests[22m[2m)[22m[33m 350[2mms[22m[39m
...
[2m Test Files [22m [1m[32m5 passed[39m[22m[90m (5)[39m
[2m      Tests [22m [1m[32m75 passed[39m[22m[90m (75)[39m
[2m   Start at [22m 00:49:58
[2m   Duration [22m 1.60s[2m (transform 76ms, setup 0ms, collect 180ms, tests 1.33s, environment 0ms, prepare 22ms)[22m
...
[2m Test Files [22m [1m[32m5 passed[39m[22m[90m (5)[39m
[2m      Tests [22m [1m[32m130 passed[39m[22m[90m (130)[39m
[2m   Start at [22m 00:50:00
[2m   Duration [22m 546ms[2m (transform 86ms, setup 0ms, collect 198ms, tests 259ms, environment 0ms, prepare 22ms)[22m
```
...
```
__GATE__ build_exit=0 test_exit=0 build_cmd=[npm run build] test_cmd=[npm test] head=fbb82700df25d4a8debb0967d4327c951fdfde72 test_files=33 skip_marks=0 shadow_files=0
Warning: useLayoutEffect does nothing on the server, because its effect cannot be encoded into the server renderer's output format. This will lead to a mismatch between the initial, non-hydrated UI and the intended UI. To avoid this, useLayoutEffect should only be used in components that render exclusively on the client. See https://reactjs.org/link/uselayouteffect-ssr for common fixes.
    at LinkWithRef (/home/daytona/project/node_modules/react-router-dom/dist/umd/react-router-dom.development.js:814:9)
    at NavLinkWithRef (/home/daytona/project/node_modules/react-router-dom/dist/umd/react-router-dom.development.js:892:25)
    at li
...
[2m Test Files [22m [1m[32m5 passed[39m[22m[90m (5)[39m
[2m      Tests [22m [1m[32m130 passed[39m[22m[90m (130)[39m
[2m   Start at [22m 00:58:00
[2m   Duration [22m 551ms[2m (transform 100ms, setup 0ms, collect 216ms, tests 248ms, environment 0ms, prepare 22ms)[22m
